...
func ReadFrVectorShader() (string, error) {
	return metal.ReadShader("curves/bn254/fr_vector.wgsl")
}
...
func (k *FrVectorKernel) Copy(input []metal.U32x8) ([]metal.U32x8, error) {
	return k.Run(FrVectorOpCopy, input, nil, 0)
}

func (k *FrVectorKernel) Add(input, aux []metal.U32x8) ([]metal.U32x8, error) {
	return k.Run(FrVectorOpAdd, input, aux, 0)
}

func (k *FrVectorKernel) Sub(input, aux []metal.U32x8) ([]metal.U32x8, error) {
	return k.Run(FrVectorOpSub, input, aux, 0)
}

func (k *FrVectorKernel) MulFactors(input, factors []metal.U32x8) ([]metal.U32x8, error) {
	return k.Run(FrVectorOpMulFactors, input, factors, 0)
}

func (k *FrVectorKernel) BitReverseCopy(input []metal.U32x8) ([]metal.U32x8, error) {
