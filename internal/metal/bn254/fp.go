...
func ReadFpArithShader() (string, error) {
	return metal.ReadShader("curves/bn254/fp_arith.wgsl")
}
...
func RunFpOperation(device *wgpu.Device, op FpOp, a, b []metal.U32x8) ([]metal.U32x8, error) {
...
func (k *FpKernel) Run(op FpOp, a, b []metal.U32x8) ([]metal.U32x8, error) {
...
func flattenFpBatch(in []metal.U32x8) []byte {
...
func unflattenFpBatch(data []byte, count int) []metal.U32x8 {
