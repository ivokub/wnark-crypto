...
func (k *FrVectorKernel) Add(input, aux []curvegpu.U32x8) ([]curvegpu.U32x8, error) {
	return k.Run(FrVectorOpAdd, input, aux, 0)
}

func (k *FrVectorKernel) Sub(input, aux []curvegpu.U32x8) ([]curvegpu.U32x8, error) {
...
func (k *FrVectorKernel) RunProfiled(op FrVectorOp, input, aux []curvegpu.U32x8, logCount uint32) ([]curvegpu.U32x8, FrVectorProfile, error) {
	count := len(input)
	if count == 0 {
